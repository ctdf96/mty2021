...
<form:form modelAttribute="membersModel">
		...
		<div class="form-row">
		<label for ="phoneNumber" class ="disp-block">電話番号
		<small>（ハイフンなし・半角数字）</small></label>
		<form:input path ="phoneNumber" />
		<form:errors path ="phoneNumber" element ="span" cssClass ="errors" />
		</div>

		<div class="form-row">
		<label for ="birthday" class ="disp-block">誕生日
		...
		<div></div>
		<div class="form-row">
		<input type ="submit" value ="登録する" class="btn"></div>
